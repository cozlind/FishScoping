...
public class step1 : MonoBehaviour {
	...
	void Update () {
		...
		if(f==0&&timer>8.0f){
			...
			f=1;
		}else if(f==1&&timer>9.0f){
			sound03.PlayOneShot(sound03.clip);
			f=2;
		}else if(f==2&&timer>17.0f){
